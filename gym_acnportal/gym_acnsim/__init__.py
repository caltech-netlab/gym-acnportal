...
gym_env_dict: Dict[str, str] = {
    ...
    "default-acnsim-v0": "acnportal.acnsim.gym_acnsim.envs:make_default_sim_env",
    "rebuilding-acnsim-v0": "acnportal.acnsim.gym_acnsim.envs:RebuildingEnv",
    "default-rebuilding-acnsim-v0": "acnportal.acnsim.gym_acnsim.envs:make_rebuilding_default_sim_env",
}
